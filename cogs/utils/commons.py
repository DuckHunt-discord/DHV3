...
def init():
    ...
    canards_bye = [_("The duck went away  ·°'\`'°-.,¸¸.·°'\`"), _("The ducks went to another world  ·°'\`'°-.,¸¸.·°'\`"), _("The duck did not have time for this  ·°'\`'°-.,¸¸.·°'\`"), _("The duck left.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck dissipate in space-time.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck leave of boredoom.  ·°'\`'°-.,¸¸.·°'\`"), _("The duck doesn't want to be sniped.  ·°'\`'°-.,¸¸.·°'\`")]
