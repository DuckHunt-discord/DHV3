...
class Experience(commands.Cog):
    ...
    async def item21(self, ctx):
        ...
        if random.randint(1, 6) == 1:
            ...
            tempmsg = _("The ducks are sensing your delicious wafers...", language)
        ...
        await self.bot.send_message(ctx=ctx,
                                    message=_(":money_with_wings: You put some bread on the channel to attract ducks. ", language) + tempmsg)
